...
public interface IBaseDao<T> {
	...
	public List<T> find(String hql, Object[] args, Map<String, Object> alias);   //既有别名,又有通配符
	public List<T> find(String hql, Map<String, Object> alias);   //只有别名,没有通配符
	 ...
	 * @param args 查询的条件
	 * @param clazz  查询的实体对象
	 * @param hasEntity  该对象是否是一个hibernate所管理的实体,
	 * 					如果不是则需要使用 setResultTransform查询
	 * @return  返回一组对象
	 */
